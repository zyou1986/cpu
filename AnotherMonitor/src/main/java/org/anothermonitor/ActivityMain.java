...
//	private ScriptIntrinsicBlur intrinsic;
    ...
    private Handler mHandler = new Handler(), mHandlerVG = new Handler(), mH = new Handler() {
        @Override
        public void handleMessage(Message msg) {
            super.handleMessage(msg);
            wm.updateViewLayout(mVG, lp);
...
//		mVG = (ViewGraphic) findViewById(R.id.ANGraphic);
        mVG = new ViewGraphic(getApplicationContext(), null);
...
//		tv.setText("我是不是你最疼爱的人，你为什么不说话，握住是你冰冷的手动也不动让我好难过");
        mVG.setBackgroundColor(Color.alpha(10));
        wm.addView(mVG, lp);
